...
export default function Experience() {
  ...
  const experiences = [
    {
      role: "Shift Engineer",
      company: "Henry and Farad Pvt Ltd",
      duration: "2022 – 2024",
      points: [
...

    {
      ...
      company: "Reliance Big Synergy",
      duration: "2020 – 2021",
      points: [
        <>
          Researched and developed factual quiz content for the Malayalam television program{" "}
          <em className="italic">Anchinodu Inchodinchu</em>.
        </>,
...

    {
      ...
      points: [
        <>
          Conducted research and developed verified quiz content for{" "}
          <em className="italic">Ningalkkum Aakam Kodeeshwaran</em>, Malayalam adaptation of{" "}
          <em className="italic">Who Wants to Be a Millionaire?</em>
        </>,
